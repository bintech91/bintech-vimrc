...
# Introduction
I am a vim newbie, so I tried to inherit the tweak from an experienced vim users [vimrc](https://github.com/amix/vimrc/). However, I made an improvement (to me - a newbie) to made it easier to use and friendlier to newbie.

# How to install?
## Install on your laptop:
The awesome version includes a lot of great plugins, configurations and color schemes that make Vim a lot better. To install it simply do following from your terminal:

	git clone https://github.com/bintech91/bintech-vimrc.git
	cd bintech-vimrc
    sh install.sh
	
Open vim/nvim and run PlugInstall to install vim plugins:

    :PlugInstall

Get the list of coc extensions from https://github.com/bintech91/bintech-vimrc/coc_extensions.txt and install
